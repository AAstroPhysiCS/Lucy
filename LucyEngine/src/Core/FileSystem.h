...
namespace Lucy {
	...
	template<typename T>
	inline void FileSystem::WriteToFile(const std::string& path, const std::vector<T>& data, OpenMode mode) {
	...
	template<typename T>
	inline void FileSystem::ReadFile(const std::string& path, std::vector<T>& data, OpenMode mode) {
	...
	template<typename T>
	inline void FileSystem::ReadFileLine(const std::string& path, std::vector<T>& data) {
		std::ifstream f(path);
