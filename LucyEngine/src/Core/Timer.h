	...
	public:
		...
		~ScopedTimer() {
			...
			case TimeUnit::Microseconds:
				LUCY_INFO(fmt::format("Mesh import took {0} us.", GetElapsedMicroseconds()));
				break;
			case TimeUnit::Milliseconds:
				LUCY_INFO(fmt::format("Mesh import took {0} ms.", GetElapsedMilliseconds()));
				break;
			case TimeUnit::Nanoseconds:
				LUCY_INFO(fmt::format("Mesh import took {0} ns.", GetElapsedNanoseconds()));
				break;
			}
		}
	private:
